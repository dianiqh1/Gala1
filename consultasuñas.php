...
<body>
        ...
        <button type="button" >click para añadir</button> <a href="uñas.php" target="_blank">añadir</a>
...
$sql = "SELECT id,  nombre, precio FROM manicure";
...
echo "</tr>";
  ...
  while($row = $result->fetch_assoc()) {
   // echo "id: ".$row["id"]."nombre: ".$row["nombre"]."precio".$row["precio"]."<br>";
    echo"<tr>";
   echo "<td>".$row["id"]."</td><td>".$row["nombre"]."</td><td>".$row["precio"]."</td>
    <td><a href rel =modificaru.php'>modificar</a></td><td><a href='eliminaru.php'>eliminar</a></td>";
    echo"</tr>";
