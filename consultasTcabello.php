...
<body>
        ...
        <button type="button" >click para añadir</button> <a href="Tcabello.php" target="_blank">añadir</a>
...
$sql = "SELECT id,  producto, precio FROM tcabello";
...
echo "<table>";
echo "<tr>";
echo "<th>id</th><th>producto</th><th>precio</th><th>Acciones</th>";
echo "</tr>";
  // output data of each row
  while($row = $result->fetch_assoc()) {
   // echo "id: ".$row["id"]."producto: ".$row["producto"]."precio".$row["precio"]."<br>";
    echo"<tr>";
    echo "<td>".$row["id"]."</td><td>".$row["producto"]."</td><td>".$row["precio"]."</td><td><a href='modificartratamiento.php'>Modificar</a></td><td><a href='eliminartc.php'>Eliminar</a></td>";
    echo"</tr>";
  }
  echo "</table>";
} else {
