...
<body>
        ...
        <button type="button" >click para añadir</button> <a href="productos.php" target="_blank">añadir</a>
...
echo "<table>";
echo "<tr>";
echo "<th>id</th><th>nombre</th><th>descripcion</th><th>precio</th><th>Acciones</th>";
echo "</tr>";
  // output data of each row
  while($row = $result->fetch_assoc()) {
   // echo "id: ".$row["id"]."nombre: ".$row["nombre"]."descripcion".$row["descripcion"]."precio: ".$row["precio"]."<br>";
    echo"<tr>";
    echo "<td>".$row["id"]."</td><td>".$row["nombre"]."</td><td>".$row["descripcion"]."</td><td>".$row["precio"]."</td><td><a href='modificarpro.php'>Modificar</a></td><td><a href='eliminarpro.php'>Eliminar</a></td>";
    echo"</tr>";
  }
  echo "</table>";
} else {
