...
<body>
    ...
    <body>
        ...
        <button type="button" >click para añadir</button> <a href="insertprovedores.php" target="_blank">añadir</a>
...
$sql = "SELECT id,  nombre, rfc FROM provedores";
...
echo "<table>";
echo "<tr>";
echo "<th>id</th><th>nombre</th><th>Edad</th><th>RFC</th><th>Acciones</th>";
echo "</tr>";
  // output data of each row
  while($row = $result->fetch_assoc()) {
   // echo "id: ".$row["id"]."nombre: ".$row["nombre"]."rfc".$row["rfc"]."<br>";
    echo"<tr>";
    echo "<td>".$row["id"]."</td><td>".$row["nombre"]."</td><td>".$row["rfc"]."</td><td><a href='modificarpro.php'>Modificar</a></td><td><a href='eliminarpro.php'>Eliminar</a></td>";
    echo"</tr>";
  }
  echo "</table>";
} else {
