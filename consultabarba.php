...
<body>
        ...
        <button type="button" >click para añadir</button> <a href="barba.php" target="_blank">añadir</a>
...
$sql = "SELECT id,  nombre, precio FROM barba";
...
echo "</tr>";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo"<tr>";
    echo "<td>".$row["id"]."</td><td>".$row["nombre"]."</td><td>".$row["precio"]."</td><td><a href='modificarb.php'>Modificar</a></td><td><a href='eliminarb.php'>Eliminar</a></td>";
    echo"</tr>";
  }
  echo "</table>";
} else {
