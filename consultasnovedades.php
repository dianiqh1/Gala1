...
<body>
        ...
        <button type="button" >click para añadir</button> <a href="novedades.php" target="_blank">añadir</a>
...
$sql = "SELECT id,  nombre, precio FROM novedades";
...
echo "<table>";
echo "<tr>";
echo "<th>id</th><th>nombre</th><th>precio</th><th>Acciones</th><th>Acciones</th>";
echo "</tr>";
  // output data of each row
  while($row = $result->fetch_assoc()) {
    echo "id: ".$row["id"]."nombre: ".$row["nombre"]."precio".$row["precio"]."<br>";
    echo"<tr>";
    echo "<td>".$row["id"]."</td><td>".$row["nombre"]."</td><td>".$row["precio"]."</td><td><a href='modificarn.php'>Modificar</a></td><td><a href='eliminarn.php'>Eliminar</a></td>";
    echo"</tr>";
  }
  echo "</table>";
} else {
